...
work_str = []
"""
разобрать in_str на фрагменты по 13 символов с начала строки.
сделать список из произведений  
"""
while start < len(in_str):
    ...
    start += 1
clear_str = list(filter(lambda value: not "0" in value, work_str))
...
#     i -- простое и 0 иначе. Сложность: n_loglog(n).
# '''
...
#     sum_quadrant += num * num
#     sum += num
#
# print(sum * sum - sum_quadrant)
